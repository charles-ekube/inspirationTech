...
import { courses } from "../../utils/Helper";
      ...
      <section className={"stackSection"}>
        ...
        <div className={"stacksGrid"}>
          {courses.map((course, index) => {
            return <StacksCard title={course.courseName} description={course.courseDesc} src={course.courseImage} onClick={() => goToCourseDetails(course)} />;
          })}
